...
def generate_svg(stats, root_dir):
    ...
    top_bar_y = 106
    top_bar_height = 13
    content_start_y = top_bar_y + top_bar_height + 34
...
{font_face}
    ...
    .lang-name {{ font-family: {FONT_FAMILY}; font-size: 13px; fill: #e6edf3; }}
    .lang-pct {{ font-family: {FONT_FAMILY}; font-size: 13px; fill: #8b949e; }}
    .bar-label {{ font-family: {FONT_FAMILY}; font-size: 13px; font-weight: 600; fill: #0d1117; }}
...
<text class="header title-anim" x="22" y="32">📊 wasm-lang-test · Code Distribution</text>
<text class="subtitle title-anim" style="animation-delay: 0.2s;" x="22" y="52">Total {format_bytes(total)} ({total:,} bytes)</text>
<text class="subtitle title-anim" style="animation-delay: 0.3s;" x="22" y="72">Auto update: {datetime.now(timezone.utc).strftime("%Y-%m-%d %H:%M")} UTC</text>
<text class="subtitle title-anim" style="animation-delay: 0.4s;" x="22" y="92">Tracked: {", ".join(LANG_EXTENSIONS.keys())}</text>
''')
